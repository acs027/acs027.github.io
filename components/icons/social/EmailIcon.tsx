...
export function EmailIcon(props: { size?: number, color?: string }) {
  ...
  return (
	...
	<Path fill={color} d="M440.917,67.925H71.083C31.827,67.925,0,99.752,0,139.008v233.984c0,39.256,31.827,71.083,71.083,71.083
